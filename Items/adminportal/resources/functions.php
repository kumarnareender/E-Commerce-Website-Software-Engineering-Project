...
$product_title          = escape_string(strip_tags($_POST['product_title']));
$product_category_id    = escape_string(strip_tags($_POST['product_category_id']));
$product_price          = escape_string(strip_tags($_POST['product_price']));
$product_description    = escape_string(strip_tags($_POST['product_description']));
$short_desc             = escape_string(strip_tags($_POST['short_desc']));
$product_quantity       = escape_string(strip_tags($_POST['product_quantity']));
...
$cat_title = escape_string(strip_tags($_POST['cat_title']));
...
$password   = escape_string(strip_tags($_POST['password']));
...
$slide_title        = escape_string(strip_tags($_POST['slide_title']));
